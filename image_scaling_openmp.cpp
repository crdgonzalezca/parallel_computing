...
*/
void *nearest_neighbour_scaling(int idv) {
...
//   g++ image_scaling.cpp -o image_scaling -std=c++11 `pkg-config --cflags --libs opencv`  -lpthread -fopenmp -lm
